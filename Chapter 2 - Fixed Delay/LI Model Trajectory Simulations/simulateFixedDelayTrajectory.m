...
for tau_index = 1:tau_amt
    ...
    sol = computeFixedDelayLISchnakenbergTrajectory(a,b,tau_value,max(t_mesh), u0,v0,10e-12,10e9);
...
%legend
hold off;
filename = "Output_Images/Fixed_Delay_LI_Model_uv_Trajectory.eps";
...
hold off;
legend
filename = "Output_Images/Fixed_Delay_LI_Model_u_values.eps";
print('-depsc', '-tiff', '-r300', '-painters', filename);
...
hold off;
legend
filename = "Output_Images/Fixed_Delay_LI_Model_v_values.eps";
print('-depsc', '-tiff', '-r300', '-painters', filename);
