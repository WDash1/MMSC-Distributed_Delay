...
for n = n_values
    ...
    spmd(4)
        if labindex == 1
            ...
            [~, trapezium_soly] = compute_trajectory_simulation(trapezium_rule_zeros, trapezium_rule_weights,alpha, beta, t_values, y0);
            if(n>1)
        ...
        elseif labindex == 2
            ...
            [~, simpsons_soly] = compute_trajectory_simulation(simpsons_rule_zeros, simpsons_rule_weights,alpha, beta, t_values, y0);
            if(n>1)
        ...
        elseif labindex == 3
            ...
            [~, simpsons_38_soly] = compute_trajectory_simulation(simpsons_38_rule_zeros, simpsons_38_rule_weights,alpha, beta, t_values, y0);
            if(n>1)
        ...
        elseif labindex == 4
            ...
            [~, legendre_soly] = compute_trajectory_simulation(gauss_legendre_zeros, gauss_legendre_weights,alpha, beta, t_values, y0);
            if(n>1)
