...
parfor n = n_values
   ...
   trapezium_rule_cauchy_sequence(n) = max(abs(trapezium_soly - exp(t_values)));
   ...
   simpsons_rule_cauchy_sequence(n) = max(abs(simpsons_soly - exp(t_values)));
   ...
   simpsons_38_rule_cauchy_sequence(n) = max(abs(simpsons_38_soly - exp(t_values)));
