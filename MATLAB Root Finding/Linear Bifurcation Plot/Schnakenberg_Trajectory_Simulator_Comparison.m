...
[u_values, v_values] = computeNoDelaySchnakenbergTrajectory(a,b,t_mesh,u0(0),v0(0),10e-9,10e9);
plot(u_values, v_values, 'DisplayName',"No delay");

%Plot the fixed delay trajectory.
sol = computeFixedDelaySchnakenbergTrajectory(a,b,tau,max(t_mesh), u0,v0,10e-9,10e9);
...
sigma_amt = 4;
sigma_values = linspace(0.001,0.03,sigma_amt);
